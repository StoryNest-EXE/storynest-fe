      ...
      <div className="loader" style={{ transform: "scale(0.3)" }}>
        ...
        >
          <path
            ...
            strokeWidth={8}
            stroke="url(#b)"
            d="M 50,10 C 50,10 45,4 32,4 19,4 14,10 14,17 14,24 19,28 32,28 45,28 50,32 50,39 50,46 45,52 32,52 19,52 14,46 14,46"
            className="dash"
            pathLength={360}
          />
        </svg>
        ...
        >
          <path
            ...
            strokeWidth={8}
            stroke="url(#d)"
            d="M 32 32 m 0 -23 a 23 23 0 1 1 0 46 a 23 23 0 1 1 0 -46"
            className="dash"
            pathLength={360}
          />
        </svg>
        ...
        >
          <path
            ...
            strokeWidth={8}
            stroke="url(#b)"
            d="M 14,54 V 10 H 38 C 45,10 50,15 50,22 50,29 45,34 38,34 H 14 M 38,34 L 50,54"
            className="dash"
            pathLength={360}
          />
        </svg>
        ...
        >
          <path
            ...
            strokeWidth={8}
            stroke="url(#c)"
            d="M 14,10 L 32,32 L 50,10 M 32,32 V 54"
            className="dash"
            pathLength={360}
          />
        </svg>
        ...
        >
          <path
            ...
            strokeWidth={8}
            stroke="url(#b)"
            d="M 50,10 H 14 V 32 H 45 M 14,32 V 54 H 50"
            className="dash"
            pathLength={360}
          />
        </svg>
...
export default StoryNestLoader;
